...
public class GLKProgram {
    ...
    public GLKProgram(String vertexShader, String fragmentShader) {
    ...
    public void setUniformMatrix (String name, GLKMatrix4f matrix) {
    ...
    public void setUniformMatrix (String name, GLKMatrix4f matrix, boolean transpose) {
        setUniformMatrix(fetchUniformLocation(name), matrix, transpose);
    }

    public void setUniformMatrix (int location, GLKMatrix4f matrix) {
        setUniformMatrix(location, matrix, false);
    }

    public void setUniformMatrix (int location, GLKMatrix4f matrix, boolean transpose) {
        if(location == -1) return;
     ...
     * @param name the name of the uniform
     * @param matrix the matrix */
    public void setUniformMatrix (String name, GLKMatrix3f matrix) {
        setUniformMatrix(name, matrix, false);
    }
    ...
    public void setUniformMatrix (String name, GLKMatrix3f matrix, boolean transpose) {
        setUniformMatrix(fetchUniformLocation(name), matrix, transpose);
    }

    public void setUniformMatrix (int location, GLKMatrix3f matrix) {
        setUniformMatrix(location, matrix, false);
    }

    public void setUniformMatrix (int location, GLKMatrix3f matrix, boolean transpose) {
        if(location == -1) return;
    ...
    public void setUniformf (String name, GLKVector2f vector) {
        setUniformf(name, vector.x, vector.y);
    }

    public void setUniformf (int location, GLKVector2f vector) {
    ...
    public void setUniformf (String name, GLKVector3f vector) {
        setUniformf(name, vector.x, vector.y, vector.z);
    }

    public void setUniformf (int location, GLKVector3f vector) {
    ...
    public void setUniformf (String name, GLKVector4f vector) {
        setUniformf(name, vector.x, vector.y, vector.z, vector.w);
    }

    public void setUniformf (int location, GLKVector4f vector) {
